...
export function NetworkMap({ nodes, timezone }: NetworkMapProps) {
  ...
  return (
    ...
    >
      ...
      {nodes.map((node) => {
        const color = node.is_under_jamming
          ? "#ff1744"
          : node.is_healthy
            ? "#00f2ff"
            : "#ff3e3e";
              ...
              <Popup className="cyber-popup">
                <div style={{ padding: "5px", minWidth: "170px" }}>
                  ...
                  >
                    ...
                    {node.is_verified && (
                      <span
                        title="Sovereign Audit Verified"
                  ...
                  <div style={{ color: "#90a4ae", fontSize: "11px" }}>
                    <p>
                      ...
                      <span style={{ color: "white" }}>
                        {isProxied ? "SWARM RELAY" : node.uplink.toUpperCase()}
                      </span>
                    </p>
                    {isProxied && (
                      <p>
                    ...
                    <p>
                      ...
                      <span
                        style={{
                          color: node.packet_loss > 10 ? "#ff1744" : "white",
                        }}
                      >
                    ...
                    <p>
                      ...
                      <span style={{ color: "#4db6ac" }}>
                        {formatTimestamp(node.timestamp, timezone)}
                      </span>
                    </p>
                    {isJammed && (
                      <p
                    ...
                    {!node.is_verified && (
                      ...
                      >
                        ⚠️ Integrity Check: Pending/Unverified
                      </p>
                    )}
                    {node.is_verified && (
                      <p
